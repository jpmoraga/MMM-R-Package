#' Marketing Mix Model
#'
#' Se toma una base histórica con todas las variables que influyen en la variable objetivo que se quiera predecir, por ejemplo venta.
#' En estas variables, se componen en variables de inversión en medios y y otro tipo de variables que impactan el modelo
#' @param example
#' @return example
#'
#'
